...
*   Current Version: [Fall 2019 edition](https://pp4rs.github.io/2019-foundations-uzh)
...
2. Work with Git on you computer
3. Use branches and merge work streams
...
```
Lachlan Deer & Julian Langer, 2019, Version Control with Git: Working on a Single Machine, Programming Practices for Research in Economics, University of Zurich
```
